...
def get_max_position_embeddings(model):
    """
    Get the maximum position embeddings for different model architectures.
    GPT-2 uses n_positions, Llama/Mistral use max_position_embeddings.
    """
    config = model.config
...
def layer_stats(
    ...
    def get_ds():
        ...
        maxlen = get_max_position_embeddings(model)
    ...
    npos = get_max_position_embeddings(model)
